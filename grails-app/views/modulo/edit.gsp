...
<body>
	<a href="#edit-modulo" class="skip" tabindex="-1">
		<g:message code="default.link.skip.label" default="Skip to content&hellip;" /></a>
	<div id="edit-modulo" class="content scaffold-edit" role="main">
		<h1>
			<g:message code="default.edit.label" args="[entityName]" />
		</h1>
		...
		<g:form url="[resource:moduloInstance, action:'update']" method="PUT">
			<g:hiddenField name="version" value="${moduloInstance?.version}" />
			<fieldset class="form">
				<g:render template="form" />
				<g:actionSubmit class="w-100 btn btn-lg btn-primary" action="update"
